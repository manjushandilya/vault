...
type config_esb.hcl | powershell -Command "$input | ForEach-Object { $_ -replace \"esb\", \"%1\" }" > config_%2.hcl
type config_%2.hcl | powershell -Command "$input | ForEach-Object { $_ -replace \"8002\", \"%2\" }" > config_%1.hcl
del config_%2.hcl
