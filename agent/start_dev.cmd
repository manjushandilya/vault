...
REM Create a policy
vault policy write esbrole-policy policy_esb.cnf 
...
vault read -field=role_id auth/approle/role/esbrole/role-id > role_id_file_esb
...
REM vault write -field=secret_id -f auth/approle/role/esbrole/secret-id > secret_id_file_esb
...
vault agent -config=config_esb.hcl -log-level=debug
